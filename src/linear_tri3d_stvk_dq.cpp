...
# include<../include/linear_tri3d_stvk_dq.h>
#endif

template <typename HessianType, typename DefoType, typename DerivedV,
          typename NormalType, typename DNormalType, typename Scalar,
          typename DerivedParams>
void sim::linear_tri3d_stvk_dq(
    Eigen::DenseBase<HessianType> &out, const Eigen::MatrixBase<DerivedV> &q,
    ...
    dpsi_stvk_dF(dF, unflatten<3,3>((B*qe+n_vec).eval()), params);
